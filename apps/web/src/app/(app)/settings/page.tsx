          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div>
                ...
                <input
                  className="mt-2 block w-full rounded-[1.15rem] border border-border/80 bg-surface px-4 py-3 text-sm text-foreground shadow-soft"
                  id="account-email"
                  readOnly
              ...
              <div>
                ...
                <input
                  className="mt-2 block w-full rounded-[1.15rem] border border-border/80 bg-surface px-4 py-3 text-sm text-muted-foreground shadow-soft"
                  disabled
                  id="display-name"
                  placeholder="Profile persistence is not wired yet"
                />
              </div>
              <div className="rounded-[1.2rem] border border-border/70 bg-background-subtle/70 p-4 text-sm leading-6 text-muted-foreground">
                Profile editing should write to the Supabase profile table once
                the persistence flow is connected.
              </div>
            </CardContent>
          </Card>
              ...
              {[
                ...
                return (
                  ...
                  >
                    ...
                    <Button disabled size="sm" variant="surface">
                      Planned
                    </Button>
                  </div>
                );
