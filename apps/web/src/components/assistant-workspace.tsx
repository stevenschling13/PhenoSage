            ...
            <div className="space-y-2">
              ...
              <div className="space-y-2">
                ...
                <p className="max-w-2xl text-sm leading-6 text-muted-foreground">
                  Responses stream from the same-origin chat route and stay
                  ready for future grow-context, tool output, and source
          ...
          <div className="grid gap-3 sm:grid-cols-3">
            <div className="rounded-[1rem] border border-border bg-background-subtle/50 p-4">
              ...
              <p className="mt-2 text-sm leading-6 text-muted-foreground">
                Ready to absorb plant image history and grow events as those
                queries are wired.
              </p>
            </div>
            <div className="rounded-[1rem] border border-border bg-background-subtle/50 p-4">
        ...
        <div className="border-t border-border px-6 py-5">
          ...
          <div className="mb-4 flex flex-wrap gap-2">
            {suggestedPrompts.map((prompt) => (
              <button
                key={prompt}
                className="rounded-full border border-border bg-surface px-3 py-2 text-left text-sm text-muted-foreground transition hover:border-accent hover:text-foreground"
      ...
      <aside className="space-y-4">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              These sources will feed future grow-aware replies without changing
