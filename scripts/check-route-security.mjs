...
const CRON_SECRET_RE =
  /(CRON_SECRET|VERCEL_CRON_SECRET|READINESS_PROBE_SECRET|ANALYSIS_WEBHOOK_SECRET|SUPABASE_AUTH_WEBHOOK_SECRET|SUPABASE_STORAGE_WEBHOOK_SECRET|GITHUB_WEBHOOK_SECRET|x-vercel-cron|Vercel-Cron)/;
